...
| --- | ------------------------------------------ | -------- | -------------- | ------ | -------- | --------------------------------------------------------- | ---- |
| M0  | 仓库初始化 & monorepo 骨架                 | 0.5 周   | `Not Started` | TBD    | TBD      | pnpm workspace、CI、文档站雏形                            |      |
| M1  | CLI MVP + `basic-react` 模板               | 1.5 周   | `Not Started` | TBD    | TBD      | `npx create-applet` 可用，weapp/h5 跑通                   |      |
